...
export class RegistrationComponent implements OnInit{
  ...
  constructor(private fb:FormBuilder){
    this.formgroup = this.fb.group({
      ...
      gender:['', [Validators.required, Validators.minLength(4), Validators.maxLength(5)]],
  ...
  selectClass(st_class){
    const classSubjects = {
      ...
      'Class 9-10': ['Math', 'Hindi', 'Science', 'Social Science', 'English', 'Urdu'],
  };
  this.studentSubject = [];
  this.student_Stream_subject = [];
  this.isSubject = true;
  this.selectedClass = st_class;
  if (['Class 1', 'Class 2', 'Class 3', 'Class 4', 'Class 5'].includes(st_class)) {
    ...
    // this.isSubject=true;
    // this.selectedClass = st_class;
    // if(st_class==='Class 1' || st_class==='Class 2' || st_class==='Class 3' || st_class==='Class 4' || st_class==='Class 5'){
    //   this.isStream = false;
    //   this.formgroup.get('subject')?.setValidators([Validators.required]);
    //   this.toggleDropdownFields(this.isStream);
    //   this.student_Stream_subject.push('Math', 'Hindi','Science', 'Sanskrit')
    // }else if(st_class==='Class 6' || st_class==='Class 7' || st_class==='Class 8'){
    //   this.isStream = false;
    //   this.formgroup.get('subject')?.setValidators([Validators.required]);
    //   this.toggleDropdownFields(this.isStream);
    //   this.student_Stream_subject.push('Math', 'Hindi','Science', 'Social Science','English')
    // }else if(st_class==='Class 9' || st_class==='Class 10'){
    //   this.isStream = false;
    //   this.formgroup.get('subject')?.setValidators([Validators.required]);
    //   this.toggleDropdownFields(this.isStream);
    //   this.student_Stream_subject.push('Math', 'Hindi','Science', 'Social Science','English','Urdu')
    // }else if(st_class==='Class 11' || st_class==='Class 12'){
    //   this.isStream = true;
    //   this.isSubject = false;
    //   // this.toggleDropdownFields(this.isStream);
    //   this.setStream();
  ...
  selectStream(select_stream){
    this.isSubject = true;
    if(this.selectedClass === 'Class 11' || this.selectedClass === 'Class 12'){
      
      const classData = student_Stream.find(subj => subj.className === this.selectedClass);
...
signUp(){
  createUserWithEmailAndPassword(this.auth,this.formgroup.value.email,this.formgroup.value.password)
